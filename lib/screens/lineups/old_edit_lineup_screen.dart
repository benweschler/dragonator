...
class OldEditLineupScreen extends StatefulWidget {
  final String lineupID;

  const OldEditLineupScreen({super.key, required this.lineupID});

  @override
  State<OldEditLineupScreen> createState() => _OldEditLineupScreenState();
}

class _OldEditLineupScreenState extends State<OldEditLineupScreen> {
